...
\usepackage{geometry, hyperref, sectsty, helvet}
\usepackage[resetlabels]{multibib}
\newcites{shortlist,subs}
{Selected Publications (from 17 total),Under Review (from 3 total)}
...
% Set the title size/spacing
\sectionfont{\fontsize{12}{14}\selectfont\sectionrule{0ex}{0pt}{-1ex}{1pt}}
%\titlespacing*{\section}{0pt}{12pt plus 3pt minus 3pt}{3pt plus 1pt minus 1pt}
